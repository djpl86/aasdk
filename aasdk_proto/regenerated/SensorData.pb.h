...
#ifndef SensorData_2eproto_2epb_2eh
#define SensorData_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_SensorData_2eproto;
}  // extern "C"
namespace aasdk {
namespace proto {
namespace data {
...
/* @@protoc_insertion_point(class_definition:aasdk.proto.data.Sensor) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "aasdk.proto.data.Sensor"; }
...
inline ::aasdk::proto::enums::SensorType_Enum Sensor::_internal_type() const {
  ...
  return static_cast<::aasdk::proto::enums::SensorType_Enum>(_impl_.type_);
}
...
#endif  // SensorData_2eproto_2epb_2eh
