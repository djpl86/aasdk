...
#ifndef PassengerData_2eproto_2epb_2eh
#define PassengerData_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_PassengerData_2eproto;
}  // extern "C"
namespace aasdk {
namespace proto {
namespace data {
...
extern const ::google::protobuf::internal::ClassDataFull Passenger_class_data_;
}  // namespace data
}  // namespace proto
}  // namespace aasdk
namespace google {
...
class Passenger final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:aasdk.proto.data.Passenger) */ {
 public:
  inline Passenger() : Passenger(nullptr) {}
  ~Passenger() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Passenger* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(Passenger));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR Passenger(::google::protobuf::internal::ConstantInitialized);

  inline Passenger(const Passenger& from) : Passenger(nullptr, from) {}
  inline Passenger(Passenger&& from) noexcept
      : Passenger(nullptr, ::std::move(from)) {}
  ...
  friend void swap(Passenger& a, Passenger& b) { a.Swap(&b); }
  inline void Swap(Passenger* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(Passenger* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  Passenger* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<Passenger>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const Passenger& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const Passenger& from) { Passenger::MergeImpl(*this, from); }
  ...
  void InternalSwap(Passenger* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "aasdk.proto.data.Passenger"; }

 protected:
  explicit Passenger(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  Passenger(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Passenger& from);
  Passenger(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, Passenger&& from) noexcept
      : Passenger(arena) {
    *this = ::std::move(from);
  }
...
#endif  // PassengerData_2eproto_2epb_2eh
